...
export const VideoPlayerContent = forwardRef<HTMLVideoElement, VideoPlayerContentProps>(({ className, ...props }, ref) => (
  <video ref={ref} className={cn('block w-full h-full object-contain', className)} {...props} />
));
